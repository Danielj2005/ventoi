...
<html lang="<?= LANG ?>">
    ...
    <body class="bg-dark-subtle" data-bs-theme="dark">
		...
		<main id="main" class="main">
			...
			<div class="pagetitle row">
				<div class="col-12">
                    ...
                    <h1 class="tituloUno my-3 text-white"><?=  $l_entrada == 1 ? "Historial de Compras" : "Registro de Compras" ?></h1>
									...
									<div class="col-12 dropdown">
										...
										<ul class="dropdown-menu">
											...
											<li class="p-2 text-center">
												<a class="btn btn-outline-success" target="_blank" href="./view/reportes/lista_entradas.php">
													<i class="bi bi-file-text"></i> 
													<span>Exportar Entradas</span>
												</a>
											</li>
											...
											<li class="p-2 text-center">
												...
												<form action="./view/reportes/lista_de_entradas_por_fechas.php" method="post" class="p-2 row mb-3" id="" target="_blank">
							...
							<div class="card-body">
								...
								<?php if ($l_entrada == 1) : ?>
									...
									<div id="tableListEntries" class="">
										...
										<form method="post" class="show row m-0 p-0" id="rango_fechas">
											...
											<h5 class="card-title text-white">Historial de Compras</h5>
										...
										<?php if ($l_entrada == 1 ): ?>
											...
											<div class="justify-content-between align-items-center table-responsive">
								...
								<?php endif;  if ($r_entrada == 1) : ?>
									...
									<div id="tableRegisterEntries" class="show <?= $l_entrada == 1 ? 'd-none' : '' ?>">
										...
										<form action="./controller/registrar_entrada.php" method="post" class="SendFormAjax row" autocomplete="off" data-type-form="save">
		...
		<script src="./view/js/convertir_dolar_bs.js"></script>
		<?php 
			...
			include_once "./view/inc/scripts_include.php";
