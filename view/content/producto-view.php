    ...
    <html lang="<?= LANG ?>">
        ...
        <body class="bg-dark-subtle" data-bs-theme="dark">
            ...
            <main id="main" class="main">
                ...
                <div class="pagetitle">
                    <a class="btn btn-outline-secondary mb-3" href="<?= SERVERURL; ?>dashboard">
                            ...
                            <div class="card">
                                <div class="card-body row p-3">
                                    ...
                                    <div class="setCol text-center col-12 col-md-4 mb-2 <?= $r_productos == 0 ? 'col-md-12' : 'col-md-6'?>">
                                        <div class="col-12 dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li class="p-2 text-center mb-2">
                                                    <a class="btn btn-primary" target="_blank" href="./reportes/lista_productos.php">
                                                        <i class="bi bi-file-text"></i> 
                                    ...
                                    <?php if ($l_productos == 1 ): ?>
                                        ...
                                        <div id="tableListProducts" class="justify-content-between align-items-center table-responsive">
                                            <table class="table example table-hover table-striped mb-3" id="example">
                                                <thead>
