...
const modalUrl = "http://localhost/ventoi/view/modal/";

const dataModal = {
    // modales del módulo presentaciones
    listaPresentacion : {
        modalUrl : `${modalUrl}producto/lista_presentacion.php`,
    ...
    registrarPresentacion : {
        modalUrl : `${modalUrl}producto/registrarPresentacion.php`,
    ...
    registrarCategoria : {
        modalUrl : `${modalUrl}producto/registrarCategoria.php`,
        modalTitle :  `${ICONS.reg} Registrar Nueva Categoría`,
        modalSendForm : true,
    },

    listaCategoria : {
        modalUrl : `${modalUrl}producto/lista_categoria.php`,
    ...
    listaMarca : {
        modalUrl : `${modalUrl}producto/lista_marcas.php`,
    ...
    registrarMarca : {
        modalUrl : `${modalUrl}producto/registrarMarca.php`,
    ...
    proveedorDetalles : {
        modalUrl : `${modalUrl}proveedor/detalles.php`,
        modalTitle : `${ICONS.list} Detalles del Proveedor`,
    },
    proveedorModificar : {
        modalUrl : `${modalUrl}proveedor/modificar.php`,
        modalTitle : `${ICONS.modify} Modificar Proveedor`,
        modalSendForm : true,
    },
    proveedorHistorial : {
        modalUrl : `${modalUrl}proveedor/historial.php`,
    ...
    detallesEntrada : {
        modalUrl : `${modalUrl}producto/detalles_entrada.php`,
    ...
    bitacora : {
        modalUrl : `${modalUrl}bitacora/detalles_bitacora.php`,
    ...
    servicioModificar : {
        modalUrl : `${modalUrl}servicio/modificar_servicio.php`,
    ...
    servicioDetalles : {
        modalUrl : `${modalUrl}servicio/detalles.php`,
    ...
    ventaDetalles : {
        modalUrl : `${modalUrl}venta/ventas_diarias.php`,
        modalTitle : `${ICONS.list} Detalles de la Venta`,
    },

    // modales del módulo Cliente
    clienteModificar : {
        modalUrl : `${modalUrl}cliente/modificar_cliente.php`,
        modalTitle : `${ICONS.modify} Modificar Servicio`,
        modalSendForm : true,
    },
    clienteHistorial : {
        modalUrl : `${modalUrl}cliente/historial_clientes.php`,
    ...
    usuarioModificar : {
        modalUrl : `${modalUrl}usuario/modificar_empleado.php`,
    ...
    modificarInfoPersonalUsuario : {
        modalUrl : `${modalUrl}usuario/modificar_info_personal_usuario.php`,
        modalTitle : `${ICONS.modify} Configuración de la información personal del usuario`,
        modalSendForm : true
    },

    passwordUser : {
        modalUrl : `${modalUrl}usuario/modificar_contraseña_usuario.php`,
        modalTitle : `${ICONS.modify} Configuración o Cambio de la Contraseña`,
        modalSendForm : true
    },

    preguntasSeguridad : {
        modalUrl : `${modalUrl}usuario/modificar_preguntas_seguridad.php`,
    ...
    rolDetalles : {
        modalUrl : `${modalUrl}rol/permisos_rol.php`,
        modalTitle : `${ICONS.list} Detalles de Acceso del Rol`,
        modalSize: "modal-xl"
    },
    rolModificar : {
        modalUrl : `${modalUrl}rol/modificar_rol.php`,
